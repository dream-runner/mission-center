	...
	render() {
		...
		forEach(categories, (category, i) => {
			...
			forEach(category.forms, (form, j) => {
				...
				forms.push(
					<li onClick={this.doubleClickHandle(form.id).bind(this)}
		...
		return (
			<Dialog show={isOpen} onHide={hide} onPrimary={primary} noFooter={true} dialogClassName="form-list-dialog"
							title="选择表单">
				<CSSTransitionGroup className="form-list-tip-wrap" component="div" transitionName="form-list-tip"
